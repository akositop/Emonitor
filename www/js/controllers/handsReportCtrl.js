...
app.controller('handsReportCtrl', function($scope,$state,$ionicLoading,$timeout,$ionicModal,$ionicPopup,$stateParams,Service) {

///////////////////////REFRESHER/////////////////////////////
  $scope.doRefresh = function() {
    
      //simulate async response
      Service.gethandsreport().then(function(data){
